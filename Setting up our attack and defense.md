...
![[Pasted image 20260801200823.png]]
...
![[Pasted image 20260802132229.png]]
...
First step of recon:
![[Pasted image 20260801201125.png]]
...
![[Pasted image 20260802183112.png]]

Utilizing open 3389th port we enumerate for what usernames exists in target machine using netexec tool.(instead hydra can be utilized)![[Pasted image 20260801181745.png]]

this shows up on our SIEM like this:
![[Pasted image 20260802183900.png]]
...
![[Pasted image 20260801182922.png]]as we can see attacker found the passcode of wazuh.
We can also see it at the dashboard I have created for ease of visualization:
![[Pasted image 20260802184609.png]]
...
![[Pasted image 20260802191526.png]]rule number 100107 also is triggered when powershell creates a new file. Both rules are custom made and is like this
![[Pasted image 20260802191636.png]]
...
![[Pasted image 20260802200324.png]]
...
![[Pasted image 20260802200219.png]]
...
![[VirtualBox_Windows_02_08_2026_20_44_15.png]]
...
![[VirtualBox_Windows_02_08_2026_21_24_22.png]]
According to Path and used \*.exe to disable execution of all .exe extensioned files.
![[VirtualBox_Windows_02_08_2026_21_30_31.png]]
I also used same steps to create rules for .bat and .cmd files. Now it looks like this:
![[VirtualBox_Windows_02_08_2026_21_34_46.png]]


![[VirtualBox_Windows_02_08_2026_21_15_13.png]]
...
![[VirtualBox_Windows_02_08_2026_21_13_13 1.png]]
with clicking "Enabled" there and the "Show..." button I wrote down all possible names for Powershell's execution.
![[VirtualBox_Windows_02_08_2026_22_04_09.png]]testUser can't launch Powershell and Command prompt at all